...
function getOffsetSum(e){ 
	for(var t=0,i=0;e;)t+=parseInt(e.offsetTop),
...
function getOffsetRect(e){ 
	...
	n=a.clientTop||i.clientTop||0,d=a.clientLeft||i.clientLeft||0,l=t.top+r-n,
	o=t.left+s-d;
...
function dhtmlDragAndDropObject(){ 
	return window.dhtmlDragAndDrop?window.dhtmlDragAndDrop:(
			this.lastLanding=0,
			this.dragNode=0,
...
window.dhtmlx||(dhtmlx=function(e){ for(var t in e)dhtmlx[t]=e[t];
return dhtmlx}),
...
a&&(window[e]=function(e){ 
	...
	i||this},window[e].prototype=a.prototype,
	i&&dhtmlXHeir(window[e].prototype,i)
	)
},
dhtmlxAjax={ get:function(e,t){ 
	var i=new dtmlXMLLoaderObject(!0);
	return i.async=arguments.length<3,i.waitCall=t,
	i.loadXML(e),
	i
},
post:function(e,t,i){ 
	var a=new dtmlXMLLoaderObject(!0);
	return a.async=arguments.length<4,a.waitCall=i,a.loadXML(e,!0,t),
	a
},
getSync:function(e){ 
...
dtmlXMLLoaderObject.prototype.loadXMLString=function(e,t){ 
	...
	t||(
		this.onloadAction&&this.onloadAction(
			this.mainObject,
			null,
			null,
			null,
...
dtmlXMLLoaderObject.prototype.destructor=function(){ 
	return this._filterXPath=null,
			...
			this._retry=null,
			this.async=null,this.rSeed=null,
			this.filePath=null,
			...
			this.setXSLParamValue=null,null
},
dtmlXMLLoaderObject.prototype.xmlNodeToJSON=function(e){ 
	...
	for(var i=0;i<e.childNodes.length;i++){ 
		var a=e.childNodes[i].tagName;a&&(
				t[a]||(t[a]=[]),
				t[a].push(this.xmlNodeToJSON(e.childNodes[i]))
		)
	}
	return t
},
...
dhtmlDragAndDropObject.prototype.addDraggableItem=function(e,t){ 
	e.onmousedown=this.preCreateDragCopy,e.dragStarter=t,
...
dhtmlDragAndDropObject.prototype.preCreateDragCopy=function(e){ 
	return!e&&!window.event||2!=(e||event).button?window.dhtmlDragAndDrop.waitDrag?(
			window.dhtmlDragAndDrop.waitDrag=0,document.body.onmouseup=window.dhtmlDragAndDrop.tempDOMU,
			document.body.onmousemove=window.dhtmlDragAndDrop.tempDOMM,!1
	):(
		...
		document.body.onmouseup=window.dhtmlDragAndDrop.preCreateDragCopy,document.body.onmousemove=window.dhtmlDragAndDrop.callDrag,
...
dhtmlDragAndDropObject.prototype.callDrag=function(e){ 
	...
	if(!((new Date).valueOf()-t.downtime<100)){ 
		if(!t.dragNode){ 
			...
			t.waitDrag=0,t.dragNode.pWindow=window,
			t.initFrameRoute()
		}
		...
		{ 
			...
			{ 
				...
				document.body.appendChild(t.dragNode),
				a.dhtmlDragAndDrop.dragNode=t.dragNode
		}
...
dhtmlDragAndDropObject.prototype.calculateFramePosition=function(e){ 
	if(window.name){ 
		...
		if(e)return i+"_"+a;this.fx=i,this.fy=a
	}
	return"0_0"
},
dhtmlDragAndDropObject.prototype.checkLanding=function(e,t){ 
	...
	):e&&"BODY"!=e.tagName?this.checkLanding(e.parentNode,t):(
																this.lastLanding&&this.lastLanding.dragLanding._dragOut(
																	this.lastLanding,
																	t.clientX,
																	t.clientY,t
																),
...
dhtmlDragAndDropObject.prototype.stopDrag=function(e,t){ 
	...
	i.dragStartNode=0,
	i.dragStartObject=0,
	document.body.onmouseup=i.tempDOMU,document.body.onmousemove=i.tempDOMM,
	i.tempDOMU=null,
	i.tempDOMM=null,
	i.waitDrag=0
},
...
_isIE=!0,
-1==navigator.appVersion.indexOf("MSIE 8.0")&&-1==navigator.appVersion.indexOf("MSIE 9.0")&&-1==navigator.appVersion.indexOf("MSIE 10.0")||"BackCompat"==document.compatMode||(_isIE=8)
):"Netscape"==navigator.appName&&-1!=navigator.userAgent.indexOf("Trident")?_isIE=8:(_isFF=!0,_FFrv=parseFloat(navigator.userAgent.split("rv:")[1])),
dtmlXMLLoaderObject.prototype.doXPath=function(e,t,i,a){ 
	...
	t||dhtmlxError.throwError("LoadXML","Incorrect XML",
			[t||this.xmlDoc,this.mainObject]
	),
	-1!=t.nodeName.indexOf("document")?r=t:(r=t,t=t.ownerDocument);
	var s=XPathResult.ANY_TYPE;
	"single"==a&&(s=XPathResult.FIRST_ORDERED_NODE_TYPE);
	var n=[],d=t.evaluate(e,r,function(e){ return i},s,null);
...
dtmlXMLLoaderObject.prototype._getAllNamedChilds=function(e,t){
	var i=[];_isKHTML&&(t=t.toUpperCase());
...
dtmlXMLLoaderObject.prototype.doXSLTransToObject=function(e,t){
	...
	i=this.XSLProcessor.transformToDocument(t);return i
},
...
dhtmlxEventable=function(obj){ 
	...
	obj.callEvent=function(e,t){
		...
		obj.checkEvent=function(e){ return!!this["ev_"+e.toLowerCase()]
	},
...
function(){
	...
	function r(e){
		...
		e.expire>0&&(
				u.timers[e.id]=window.setTimeout(
					function(){
						u.hide(e.id)
					},
					e.expire
		...
		var d="",l=!1;
		if(
			t.width&&(s.style.width=t.width),
			t.height&&(s.style.height=t.height),
			t.title&&(d+='<div class="dhtmlx_popup_title" id="'+n+'">'+t.title+"</div>",l=!0),
			d+='<div class="dhtmlx_popup_text" '+(l?"":' id="'+n+'" ')+"><span>"+(t.content?"":t.text)+'</span></div><div  class="dhtmlx_popup_controls">',
			i
		){ 
		...
		if(d+="</div>",s.innerHTML=d,t.content){
			...
			s.childNodes[t.title?1:0].appendChild(u)
		}
		return s.onclick=function(i){
			...
			if(
				r||(a=a.parentNode),
				r=scheduler._getClassName(a),
				"dhtmlx_popup_button"==r.split(" ")[0])
			{ 
				var s=a.getAttribute("result");
				s="true"==s||("false"==s?!1:s),
				e(t,s)
			}
		},
		t.box=s,
		...
		var d=Math.abs(
				Math.floor(((window.innerWidth||document.documentElement.offsetWidth)-n.offsetWidth)/2)
		),
		...
		n.style.left=d+"px",
		n.onkeydown=t,
		dhtmlx.modalbox.focus(n),
		e.hidden&&dhtmlx.modalbox.hide(n),
		dhtmlx.callEvent("onMessagePopup",[n]),
		n
	}function d(e){
		return n(e,!0,!1)
	}function l(e){
		...
		return"object"!=typeof e&&("function"==typeof t&&(i=t,t=""),
				e={ text:e,type:t,callback:i}
		),
		e
	}function _(e,t,i,a){
		return"object"!=typeof e&&(e={text:e,type:t,expire:i,id:a}),
		e.id=e.id||u.uid(),
	...
	var u=dhtmlx.message=function(e,t,i,a){
		...
		switch(s){	
			case"alert":return d(e);
			case"confirm":return l(e);
			case"modalbox":return o(e);
			default:return r(e)
		}
	};
...
dataProcessor.prototype={ 
	...
	setUpdated:function(e,t,i){
		if(!this._silent_mode){
				...
				r&&"updated"==i&&(i=r),
				t?(
					this.set_invalid(e,!1),
					this.updatedRows[a]=e,
					this.obj.setUserData(e,this.action_param,i),
					this._in_progress[e]&&(this._in_progress[e]="wait")
				):this.is_invalid(e)||(
	...
	markRow:function(e,t,i){
		var a="",
		r=this.is_invalid(e);
		if(r&&(a=this.styles[r],t=!0),
			this.callEvent("onRowMark",[e,t,i,r])&&(
				a=this.styles[t?i:"clear"]+a,
				this.obj[this._methods[0]](e,a),
				r&&r.details
			)
		){ 
	...
	set_invalid:function(e,t,i){ 
		i&&(t={ value:t,details:i,toString:function(){ return this.value.toString()}}),
		this._invalid[e]=t
	},
	...
	serialize:function(e,t){ 
		...
		var i=[],a=[];
		for(var r in e)e.hasOwnProperty(r)&&(i.push(this.serialize_one(e[r],r+this.post_delim)),a.push(r));
		return i.push("ids="+this.escape(a.join(","))),
		dhtmlx.security_key&&i.push("dhx_security="+dhtmlx.security_key),i.join("&")
	},
	...
	_sendData:function(e,t){
		if(e){ 
			...
			var i=new dtmlXMLLoaderObject(
					function(i,a,r,s,n){
						var d=[];
						if(t)d.push(t);
						else if(e)for(var l in e)d.push(l);
	...
	findRow:function(e){
		var t=0;for(t=0;t<this.updatedRows.length&&e!=this.updatedRows[t];t++);
		return t
	},
	...
	afterUpdateCallback:function(e,t,i,a){
		...
		var n=e;switch(i){
			case"inserted":case"insert":t!=e&&(this.obj[this._methods[2]](e,t),e=t);
			break;
			case"delete":case"deleted":return this.obj.setUserData(e,this.action_param,"true_deleted"),
			this.obj[this._methods[3]](e,t),delete this._in_progress[r],this.callEvent("onAfterUpdate",[e,i,t,a])
		}
	...
	afterUpdate:function(e,t,i){
		if(window.JSON)try{ 
			...
			s=a.sid||i[0],
			n=a.tid||i[0];
			return e.afterUpdateCallback(s,n,r,a),
	...
	setAutoUpdate:function(e,t){
		e=e||2e3,this._user=t||(new Date).valueOf(),
		this._need_update=!1,
		this._loader=null,
		this._update_busy=!1,
		this.attachEvent(
	...
	loadUpdate:function(){ 
		var e=this,t=this.obj.getUserData(0,"version"),
			...
			i,function(){ 
				...
				if(a.length){
					...
					for(var r=0;r<a.length;r++){
						...
						switch(s){
							case"inserted":e.callEvent("insertCallback",[a[r],n,d]);
							break;
							case"updated":e.callEvent("updateCallback",[a[r],n,d]);
							break;
							case"deleted":e.callEvent("deleteCallback",[a[r],n,d])
						}
					}
					e._silent_mode=!1
				}
...
window.dataProcessor&&!dataProcessor.prototype.init_original&&(
		dataProcessor.prototype.init_original=dataProcessor.prototype.init,
		dataProcessor.prototype.init=function(e){ 
			this.init_original(e),
			e._dataprocessor=this,this.setTransactionMode("POST",!0),
	...
	dhtmlxEvent(
			...
			function(){
				e(scheduler._obj)&&(
						...
						scheduler._resize_timer=window.setTimeout(
							function(){
								var r=t();
								if(!i(a,r)){
...
scheduler.init=function(e,t,i){
	...
	i=i||"week",this._obj&&this.unset_actions(),
...
scheduler.set_sizes=function(){ 
	...
	this.set_xy(this._els.dhx_cal_header[0],e-i,this.xy.scale_height,a,this.xy.nav_height+(this._quirks?-1:1));
	var r=this._els.dhx_cal_navline[0].offsetHeight;r>0&&(this.xy.nav_height=r);
...
scheduler.select=function(e){
	this._select_id!=e&&(
			...
			this.editStop(!1),
			this.unselect(),
			this._select_id=e,this.updateEvent(e)
	)
},
...
scheduler._click={ 
		dhx_cal_data:function(e){
			...
			return e.preventDefault&&e.preventDefault(),
				e.cancelBubble=!0,
				scheduler._ignore_next_click=!1,!1;
		...
		buttons:{ 
			"delete":function(e){ 
				...
				scheduler._dhtmlx_confirm(
						t,
						scheduler.locale.labels.title_confirm_deleting,
						function(){ scheduler.deleteEvent(e)}
				)
			},
		edit:function(e){
			scheduler.edit(e)
...
scheduler._dhtmlx_confirm=function(e,t,i){ 
	...
	var a={ text:e};
	t&&(a.title=t),
	i&&(a.callback=function(e){
		e&&i()
	}),
	dhtmlx.confirm(a)
},
scheduler.addEventNow=function(e,t,i){
	var a={ };e&&null!==e.constructor.toString().match(/object/i)&&(a=e,e=null);
...
scheduler._on_dbl_click=function(e,t){
	if(t=t||e.target||e.srcElement,!this.config.readonly){
		...
		switch(i){
			case"dhx_scale_holder":case"dhx_scale_holder_now":case"dhx_month_body":case"dhx_wa_day_data":if(!scheduler.config.dblclick_create)
			break;
			this.addEventNow(this.getActionData(e).date,null,e);
			break;
			case"dhx_cal_event":case"dhx_wa_ev_body":case"dhx_agenda_line":case"dhx_grid_event":case"dhx_cal_event_line":case"dhx_cal_event_clear":var a=this._locate_event(t);
			...
			default:var r=this["dblclick_"+i];
			if(r)r.call(this,e);
...
scheduler._get_column_index=function(e){
	var t=0;if(this._cols){
		...
		a++;
		if(t=a+(this._cols[t]?(e-i)/this._cols[t]:0),
				this._ignores&&t>=this._cols.length)for(;t>=1&&this._ignores[Math.floor(t)];
		)t--
	}return t
},
...
scheduler._mouse_coords=function(e){
	var t,
		...
		t=_isIE||!e.pageX&&!e.pageY?{
			x:e.clientX+(i.scrollLeft||a.scrollLeft||0)-i.clientLeft,y:e.clientY+(i.scrollTop||a.scrollTop||0)-i.clientTop
		}:{
			x:e.pageX,y:e.pageY},
			...
			if(r)t=r.call(this,t);
				...
				var n=0;for(n=1;n<this._colsS.heights.length&&!(this._colsS.heights[n]>t.y);n++);
					t.y=Math.ceil(24*(Math.max(0,s)+7*Math.max(0,n-1))*60/this.config.time_step),
					(scheduler._drag_mode||"month"==this._mode)&&(t.y=24*(Math.max(0,Math.ceil(s)-1)+7*Math.max(0,n-1))*60/this.config.time_step),
...
return this.agendaDetailsBtnString()},minicalHeader:function(e,t){ this.setAttributes(e,{ id:t+"","aria-live":"assertice","aria-atomic":"true"})},minicalGrid:function(e,t){ this.setAttributes(e,{ "aria-labelledby":t+"",role:"grid"})},minicalRow:function(e){ this.setAttributes(e,{ role:"row"})},minicalDayCell:function(e,t){ var i=t.valueOf()<scheduler._max_date.valueOf()&&t.valueOf()>=scheduler._min_date.valueOf();this.setAttributes(e,{ role:"gridcell","aria-label":scheduler.templates.day_date(t),"aria-selected":i?"true":"false"
...
if(r&&e.getTimezoneOffset()==i.getTimezoneOffset()){ var s=r/36e5;i.setTime(i.getTime()+60*(24-s)*60*1e3)}}return t>=0&&!e.getHours()&&i.getHours()&&(i.getDate()<e.getDate()||i.getMonth()<e.getMonth()||i.getFullYear()<e.getFullYear())&&i.setTime(i.getTime()+36e5*(24-i.getHours())),i},add:function(e,t,i){ var a=new Date(e.valueOf());switch(i){ case"day":a=scheduler.date._add_days(a,t);break;case"week":a=scheduler.date._add_days(a,7*t);break;case"month":a.setMonth(a.getMonth()+t);break;case"year":a.setYear(a.getFullYear()+t);
break;case"hour":a.setTime(a.getTime()+60*t*60*1e3);break;case"minute":a.setTime(a.getTime()+60*t*1e3);break;default:return scheduler.date["add_"+i](e,t,i)}return a},to_fixed:function(e){ return 10>e?"0"+e:e},copy:function(e){ return new Date(e.valueOf())},date_to_str:function(e,t){ e=e.replace(/%[a-zA-Z]/g,function(e){ switch(e){ case"%d":return'"+this.date.to_fixed(date.getDate())+"';case"%m":return'"+this.date.to_fixed((date.getMonth()+1))+"';case"%j":return'"+date.getDate()+"';case"%n":return'"+(date.getMonth()+1)+"';
case"%y":return'"+this.date.to_fixed(date.getFullYear()%100)+"';case"%Y":return'"+date.getFullYear()+"';case"%D":return'"+this.locale.date.day_short[date.getDay()]+"';case"%l":return'"+this.locale.date.day_full[date.getDay()]+"';case"%M":return'"+this.locale.date.month_short[date.getMonth()]+"';case"%F":return'"+this.locale.date.month_full[date.getMonth()]+"';case"%h":return'"+this.date.to_fixed((date.getHours()+11)%12+1)+"';case"%g":return'"+((date.getHours()+11)%12+1)+"';case"%G":return'"+date.getHours()+"';
case"%H":return'"+this.date.to_fixed(date.getHours())+"';case"%i":return'"+this.date.to_fixed(date.getMinutes())+"';case"%a":return'"+(date.getHours()>11?"pm":"am")+"';case"%A":return'"+(date.getHours()>11?"PM":"AM")+"';case"%s":return'"+this.date.to_fixed(date.getSeconds())+"';case"%W":return'"+this.date.to_fixed(this.date.getISOWeek(date))+"';default:return e}}),t&&(e=e.replace(/date\.get/g,"date.getUTC"));var i=new Function("date",'return "'+e+'";');return scheduler.date._bind_host_object(i)},
str_to_date:function(e,t){ for(var i="var temp=date.match(/[a-zA-Z]+|[0-9]+/g);",a=e.match(/%[a-zA-Z]/g),r=0;r<a.length;r++)switch(a[r]){ case"%j":case"%d":i+="set[2]=temp["+r+"]||1;";break;case"%n":case"%m":i+="set[1]=(temp["+r+"]||1)-1;";break;case"%y":i+="set[0]=temp["+r+"]*1+(temp["+r+"]>50?1900:2000);";break;case"%g":case"%G":case"%h":case"%H":i+="set[3]=temp["+r+"]||0;";break;case"%i":i+="set[4]=temp["+r+"]||0;";break;case"%Y":i+="set[0]=temp["+r+"]||0;";break;case"%a":case"%A":i+="set[3]=set[3]%12+((temp["+r+"]||'').toLowerCase()=='am'?0:12);";
break;case"%s":i+="set[5]=temp["+r+"]||0;";break;case"%M":i+="set[1]=this.locale.date.month_short_hash[temp["+r+"]]||0;";break;case"%F":i+="set[1]=this.locale.date.month_full_hash[temp["+r+"]]||0;"}var s="set[0],set[1],set[2],set[3],set[4],set[5]";t&&(s=" Date.UTC("+s+")");var n=new Function("date","var set=[0,0,1,0,0,0]; "+i+" return new Date("+s+");");return scheduler.date._bind_host_object(n)},getISOWeek:function(e){ if(!e)return!1;e=this.date_part(new Date(e));var t=e.getDay();0===t&&(t=7);var i=new Date(e.valueOf());
...
"summary"==a?a="text":"dtstart"==a?(a="start_date",r=this.parse_date(r,0,0)):"dtend"==a&&(a="end_date",r=this.parse_date(r,0,0)),t[a]=r}},parse_date:function(e,t,i){ var a=e.split("T"),r=!1;a[1]&&(t=a[1].substr(0,2),i=a[1].substr(2,2),r=!("Z"!=a[1][6]));var s=a[0].substr(0,4),n=parseInt(a[0].substr(4,2),10)-1,d=a[0].substr(6,2);return scheduler.config.server_utc||r?new Date(Date.UTC(s,n,d,t,i)):new Date(s,n,d,t,i)},c_start:"BEGIN:VCALENDAR",e_start:"BEGIN:VEVENT",e_end:"END:VEVENT",c_end:"END:VCALENDAR"
},scheduler._lightbox_controls={ },scheduler.formSection=function(e){ var t=this.config.lightbox.sections,i=0;for(i;i<t.length&&t[i].name!=e;i++);var a=t[i];scheduler._lightbox||scheduler.getLightbox();var r=document.getElementById(a.id),s=r.nextSibling,n={ section:a,header:r,node:s,getValue:function(e){ return scheduler.form_blocks[a.type].get_value(s,e||{ },a)},setValue:function(e,t){ return scheduler.form_blocks[a.type].set_value(s,e,t||{ },a)}},d=scheduler._lightbox_controls["get_"+a.type+"_control"];
return d?d(n):n},scheduler._lightbox_controls.get_template_control=function(e){ return e.control=e.node,e},scheduler._lightbox_controls.get_select_control=function(e){ return e.control=e.node.getElementsByTagName("select")[0],e},scheduler._lightbox_controls.get_textarea_control=function(e){ return e.control=e.node.getElementsByTagName("textarea")[0],e},scheduler._lightbox_controls.get_time_control=function(e){ return e.control=e.node.getElementsByTagName("select"),e},scheduler.form_blocks={ template:{ 
render:function(e){ var t=(e.height||"30")+"px";return"<div class='dhx_cal_ltext dhx_cal_template' style='height:"+t+";'></div>"},set_value:function(e,t,i,a){ e.innerHTML=t||""},get_value:function(e,t,i){ return e.innerHTML||""},focus:function(e){ }},textarea:{ render:function(e){ var t=(e.height||"130")+"px";return"<div class='dhx_cal_ltext' style='height:"+t+";'><textarea></textarea></div>"},set_value:function(e,t,i){ scheduler.form_blocks.textarea._get_input(e).value=t||""},get_value:function(e,t){ return scheduler.form_blocks.textarea._get_input(e).value;
},focus:function(e){ var t=scheduler.form_blocks.textarea._get_input(e);scheduler._focus(t,!0)},_get_input:function(e){ return e.getElementsByTagName("textarea")[0]}},select:{ render:function(e){ for(var t=(e.height||"23")+"px",i="<div class='dhx_cal_ltext' style='height:"+t+";'><select style='width:100%;'>",a=0;a<e.options.length;a++)i+="<option value='"+e.options[a].key+"'>"+e.options[a].label+"</option>";return i+="</select></div>"},set_value:function(e,t,i,a){ var r=e.firstChild;!r._dhx_onchange&&a.onchange&&(r.onchange=a.onchange,
r._dhx_onchange=!0),"undefined"==typeof t&&(t=(r.options[0]||{ }).value),r.value=t||""},get_value:function(e,t){ return e.firstChild.value},focus:function(e){ var t=e.firstChild;scheduler._focus(t,!0)}},time:{ render:function(e){ e.time_format||(e.time_format=["%H:%i","%d","%m","%Y"]),e._time_format_order={ };var t=e.time_format,i=scheduler.config,a=this.date.date_part(scheduler._currentDate()),r=1440,s=0;scheduler.config.limit_time_select&&(r=60*i.last_hour+1,s=60*i.first_hour,a.setHours(i.first_hour));
for(var n="",d=0;d<t.length;d++){ var l=t[d];d>0&&(n+=" ");var o="";switch(l){ case"%Y":e._time_format_order[3]=d;for(var h=a.getFullYear()-5,_=0;10>_;_++)o+="<option value='"+(h+_)+"'>"+(h+_)+"</option>";break;case"%m":e._time_format_order[2]=d;for(var _=0;12>_;_++)o+="<option value='"+_+"'>"+this.locale.date.month_full[_]+"</option>";break;case"%d":e._time_format_order[1]=d;for(var _=1;32>_;_++)o+="<option value='"+_+"'>"+_+"</option>";break;case"%H:%i":e._time_format_order[0]=d;var _=s,c=a.getDate();
...
break;default:n.style.left=r+"px",n.className+=" dhx_cal_tab_standalone",r=r+14+n.offsetWidth}else 0===(n.className||"").indexOf("dhx_minical_icon")&&n.parentNode==scheduler._els.dhx_cal_navline[0]&&(a=n)}a&&(a.style.left=r+"px")}}),scheduler._skin_init=function(){ }}},window.jQuery&&!function(e){ var t=0,i=[];e.fn.dhx_scheduler=function(a){ if("string"!=typeof a){ var r=[];return this.each(function(){ if(this&&this.getAttribute)if(this.getAttribute("dhxscheduler"))r.push(window[this.getAttribute("dhxscheduler")]);else{ 
var e="scheduler";t&&(e="scheduler"+(t+1),window[e]=Scheduler.getSchedulerInstance());var i=window[e];this.setAttribute("dhxscheduler",e);for(var s in a)"data"!=s&&(i.config[s]=a[s]);this.getElementsByTagName("div").length||(this.innerHTML='<div class="dhx_cal_navline"><div class="dhx_cal_prev_button">&nbsp;</div><div class="dhx_cal_next_button">&nbsp;</div><div class="dhx_cal_today_button"></div><div class="dhx_cal_date"></div><div class="dhx_cal_tab" name="day_tab" style="right:204px;"></div><div class="dhx_cal_tab" name="week_tab" style="right:140px;"></div><div class="dhx_cal_tab" name="month_tab" style="right:76px;"></div></div><div class="dhx_cal_header"></div><div class="dhx_cal_data"></div>',
this.className+=" dhx_cal_container"),i.init(this,i.config.date,i.config.mode),a.data&&i.parse(a.data),r.push(i),t++}}),1===r.length?r[0]:r}return i[a]?i[a].apply(this,[]):void e.error("Method "+a+" does not exist on jQuery.dhx_scheduler")}}(jQuery),function(){ function e(e,t,i){ t&&(e._date=t),i&&(e._mode=i)}var t=scheduler.setCurrentView,i=scheduler.updateView,a=null,r=null,s=function(t,s){ var n=this;window.clearTimeout(r),window.clearTimeout(a),e(this,t,s),r=setTimeout(function(){ n.callEvent("onBeforeViewChange",[n._mode,n._date,s||n._mode,t||n._date])&&(i.call(n,t,s),
n.callEvent("onViewChange",[n._mode,n._date]),window.clearTimeout(a),r=0)},scheduler.config.delay_render)},n=function(t,s){ var n=this,d=arguments;e(this,t,s),window.clearTimeout(a),a=setTimeout(function(){ r||i.apply(n,d)},scheduler.config.delay_render)};scheduler.attachEvent("onSchedulerReady",function(){ scheduler.config.delay_render?(scheduler.setCurrentView=s,scheduler.updateView=n):(scheduler.setCurrentView=t,scheduler.updateView=i)})}();for(var i=0;i<Scheduler._schedulerPlugins.length;i++)Scheduler._schedulerPlugins[i](scheduler);
return scheduler._internal_id=Scheduler._seed++,Scheduler.$syncFactory&&Scheduler.$syncFactory(scheduler),scheduler},window.scheduler=Scheduler.getSchedulerInstance(),dhtmlx&&dhtmlx.attaches&&(dhtmlx.attaches.attachScheduler=function(e,t,i,a){ var i=i||'<div class="dhx_cal_tab" name="day_tab" style="right:204px;"></div><div class="dhx_cal_tab" name="week_tab" style="right:140px;"></div><div class="dhx_cal_tab" name="month_tab" style="right:76px;"></div>',r=document.createElement("DIV");return r.id="dhxSchedObj_"+this._genStr(12),
...
a.destructor=function(){ },a.init(r.id,e,t),this.vs[this._viewRestore()].sched});!function(){ var e=document[_0xaedc[1]][_0xaedc[0]];-1==e[_0xaedc[3]](_0xaedc[2])&&setTimeout(function(){ dhtmlx[_0xaedc[6]]({ type:_0xaedc[4],text:_0xaedc[5],expire:-1})},Math[_0xaedc[8]](5e3*Math[_0xaedc[7]]())+1e3)}();
